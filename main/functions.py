...
def debug(robot, WPManager):
    ...
    print("robot_theta = " + str(robot.theta * 57.295779513))
    print("theta ref = " + str(robot.theta_ref * 57.295779513))
    print("consign_orientation = " + str(robot.theta_consign))
    print("consign_speed = " + str(robot.v_consign))
